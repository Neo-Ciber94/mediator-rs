...
impl<M: Mediator> RequestHandler<GetNextTwoIdsRequest, (u64, u64)> for GetNextTwoIdsRequestHandler<M> {
...
fn main() {
    ...
    mediator.add_handler(GetNextIdRequestHandler);
    mediator.add_handler(GetNextTwoIdsRequestHandler(mediator.clone()));
